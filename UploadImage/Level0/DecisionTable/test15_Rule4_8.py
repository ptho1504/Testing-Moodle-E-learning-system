...
class Test15():
  ...
  def test15_Rule4_8(self):
    ...
    element.send_keys("C:\\Users\\Admin\\Desktop\\Ftho-Py\\FakeData\\Rule8.docx")
    self.driver.implicitly_wait(20)
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, ".moodle-exception-message").text == "Loại tệp Tài liêu PĐF không thể chấp nhận được."
